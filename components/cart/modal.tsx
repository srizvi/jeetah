    ...
    <>
      ...
      <Transition show={isOpen}>
        <Dialog onClose={closeCart} className="relative z-50">
          ...
          >
            <Dialog.Panel className="fixed bottom-0 right-0 top-0 flex h-full w-full flex-col border-l border-gray-200 bg-gray-50/80 p-6 text-gray-950 backdrop-blur-xl dark:border-gray-700 dark:bg-gray-950/80 dark:text-gray-50 md:w-[390px]">
                ...
                <div className="flex h-full flex-col justify-between overflow-hidden p-1">
                  ...
                  <div className="py-4 text-sm text-gray-500 dark:text-gray-400">
                    <div className="mb-3 flex items-center justify-between border-b border-gray-200 pb-1 dark:border-gray-700">
                      <p>Taxes</p>
                      <Price
                        className="text-right text-base text-gray-950 dark:text-gray-50"
                  ...
                  <a
                    ...
                    className="block w-full rounded-full bg-[#08ABD9] p-3 text-center text-sm font-medium text-gray-50 opacity-90 hover:opacity-100 dark:bg-[#09bcef]"
                  >
                    Proceed to Checkout
                  </a>
                </div>
